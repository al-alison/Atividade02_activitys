...
package com.example.aliso.atividade02_activitys.util;
...
public class Utils {
    ...
    private static com.example.aliso.atividade02_activitys.util.StatusTracker mStatusTracker = com.example.aliso.atividade02_activitys.util.StatusTracker.getInstance();
